...
function Application() {
    ...
    const applyForJob = async (e) => {
        ...
        axios.post(
            `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/v1/application/apply`,
            data,
            {
                headers: {
    ...
    return (
        <>
            ...
            <section className="flex items-center justify-center m-4 p-2 rounded-md">
                <div className="bg-slate-300 shadow-md rounded-md p-4 w-full sm:w-4/5 md:w-3/5 lg:w-2/5">
                    <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={applyForJob}>
                        <Input
                            type="text"
                            name="name"
                            id="name"
                        ...
                        <button type="submit" className="w-full sm:w-40 h-10 bg-sky-500 rounded-md shadow-md font-bold">
                            Send Application
                        </button>
                    </form>
                </div>
