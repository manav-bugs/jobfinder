            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-6xl">
                {
                    testimonials.map((testimonial) => (
                        <div key={testimonial.id} className="border-4 border-red-400 p-4 bg-slate-200 flex flex-col justify-center items-center text-center">
                            <p className="text-gray-700">"{testimonial.testimonial}"</p>
                            <p className="font-bold mt-2 text-gray-900">{testimonial.user}</p>
                        </div>
                    ))
                }
            </div>
